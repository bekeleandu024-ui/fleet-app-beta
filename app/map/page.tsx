  ...
  if (isError || !data) {
    return (
      <div className="space-y-6">
        <SectionBanner>
          <SectionBanner.Header title="Map Planner" />
  ...
  return (
    <div className="space-y-6">
      <SectionBanner>
        ...
        <SectionBanner.Footer className="flex flex-wrap items-center justify-between gap-3 bg-[var(--surface-2)] text-sm text-[var(--muted)]">
          <div className="flex items-center gap-2">
